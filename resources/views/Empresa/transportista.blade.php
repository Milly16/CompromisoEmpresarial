    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><b>REGISTRAR EMPRESA TRANSPORTISTA</b></div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="form-reg-transportista" action="{{ url('/transportista/registro') }}">
                        {{ csrf_field() }}
                        ...
                        <fieldset>
                            <legend  style="font-size: 15px;"><b>Archivo requerido</b></legend>
                            
                            <div class="form-group">
                                <label for="departamento" class="col-md-4 control-label" >Descarge el siguiente archivo:</label>

                                <div class="col-md-7">
                                    <a href="/archivos/formato.xlsx" title="" class="btn btn-success">Archivo</a>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="departamento" class="col-md-4 control-label" >Llenelo y subalo nuevamente:</label>
